//button_show_query_field
//button_hide_query_field
function show_query_field(){
	try {
	   var querFildsetEl = document.getElementById("query_field_id");
	   querFildsetEl.style.display = "";
	   document.getElementById("button_hide_query_field").style.display = "";
	   document.getElementById("button_show_query_field").style.display = "none";
	} catch (err) {
		console.log(err.message);
	}
	
}
function hide_query_field(){
	try {
	   var querFildsetEl = document.getElementById("query_field_id");
	   querFildsetEl.style.display = "none";
	   document.getElementById("button_hide_query_field").style.display = "none";
	   document.getElementById("button_show_query_field").style.display = "";
	} catch (err) {
		console.log(err.message);
	}
